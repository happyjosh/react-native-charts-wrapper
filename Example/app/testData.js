...
let reverseAs = Object.assign([], as);

export const candleData = [...as, ...reverseAs, ...as];

export const lineData = candleData.map(item => item.close);
export const line2Data = candleData.map(item => item.open);
