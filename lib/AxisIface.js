...
export const axisIface = {
    ...
    limitLines: PropTypes.arrayOf(
        PropTypes.shape({
            ...
            enableDashLine: PropTypes.bool.isRequired,
            dashLineLength: PropTypes.number.isRequired,
            dashSpaceLength: PropTypes.number.isRequired,
            dashPhase: PropTypes.number.isRequired,
        })
    ),
